...
public class Reclamationlist extends BaseForm {
    ...
    reclamations = list;
         System.out.println(list+"zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz");
...
for ( Reclamation reclamation : reclamations) {
    ...
    Label CIN = new Label("objet: " + reclamation.getObjet());
    Label nomLabel = new Label("Texte de Reclamation : " + reclamation.getMessage_rec());
...
deleteButton.addActionListener(e -> {
    boolean confirmed = Dialog.show("Confirmation", "Are you sure you want to delete this reclamation?", "Yes", "No");
    if (confirmed) {
